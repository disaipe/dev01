...
export default {
    install(app: App) {
        const models: { [key: string]: IModelOptions } = keyBy(app.config.globalProperties.$page.models, 'name');

        const modelsCache: { [key: string]: typeof CoreModel } = { ...predefinedModels };
