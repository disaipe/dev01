 ...
 * @returns {undefined|string} formatted date
 */
 ...
 * @param {number} [decimals] The number of decimal places to include in the result.
...
export const filters: Record<string, (value: any, ...args: any[]) => string | undefined> = {
  formatDate,
  formatBytes,
  formatKBytes,
};
