              ...
              el-dropdown(
                ...
                template(#dropdown)
                  .grid.grid-cols-5.p-1.gap-1
                    ...
                    el-link(disabled @click='setBorder("inner")')
                      icon.text-xl(icon='material-symbols:border-inner')
                    el-link(disabled @click='setBorder("horizontal")')
                      icon.text-xl(icon='material-symbols:border-horizontal')
                    el-link(disabled @click='setBorder("vertical")')
                      icon.text-xl(icon='material-symbols:border-vertical')
                    el-link(disabled @click='setBorder("outer")')
            ...
            el-button(@click='() => alignDrop.handleOpen()')
              ...
              el-dropdown(
                ...
                template(#dropdown)
                  ...
                  el-dropdown-item.space-x-2(divided @click='setAlign("top")')
...
function syncCellStyling(row?: number, column?: number) {
  ...
  {
    const value = Number.parseInt(styles.fontWeight);
