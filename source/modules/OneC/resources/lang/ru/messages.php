...
return [
    ...
    'info base user' => 'Пользователь ИБ 1С|Пользователи ИБ 1С',
    'domain user' => 'Пользователь 1С|Пользователи 1С',
    ...
    'job' => [
        ...
        'server list sync' => [
            ...
            'description' => 'Периодическая синхронизация данных из серверных списков информационных баз.'
